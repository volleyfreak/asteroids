...
namespace asteroids {
	...
	private:
		...
		int waitForSpaceCraft = WAIT_FOR_SPACECRAFT + 1;
		...
		std::set<std::pair<BulletModel*, AsteroidsView*>> spaceCraftExplosionBullets;
		...
		void resetPosition(SpaceCraftModel& spaceCraftModel);
